"""Feature caching system for RL editor.
...
# Default cache directory (under rl_editor)
...
class FeatureCache:
    ...
    def __init__(
        ...
        Args:
            cache_dir: Cache directory (default: rl_editor/cache/)
    ...
    def clear(self, subdir: Optional[str] = None) -> int:
        ...
        if subdir:
            ...
            for subdir_name in ["features", "stems", "mel", "labels", "metadata", "full"]:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        for subdir in ["features", "stems", "mel", "labels", "full"]:
            target = self.cache_dir / subdir
            if target.exists():
