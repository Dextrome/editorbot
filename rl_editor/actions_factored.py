...
# ============================================================================
# Compatibility layer - convert old V2 discrete actions to factored
# ============================================================================

def discrete_to_factored(action_idx: int, current_beat: int, n_beats: int) -> FactoredAction:
    """Convert old discrete action index to factored action.
    
    This is for backward compatibility during transition.
    """
    # Import old action space for reference
    from .actions_v2 import ActionTypeV2, ActionSpaceV2
    
    # Create mapping based on old action definitions
    old_action = ActionTypeV2(action_idx)
    
    # Map old action to factored (type, size, amount)
    mapping = {
        ActionTypeV2.KEEP_BEAT: (ActionType.KEEP, ActionSize.BEAT, ActionAmount.NEUTRAL),
        ActionTypeV2.CUT_BEAT: (ActionType.CUT, ActionSize.BEAT, ActionAmount.NEUTRAL),
        ActionTypeV2.KEEP_BAR: (ActionType.KEEP, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.CUT_BAR: (ActionType.CUT, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.KEEP_PHRASE: (ActionType.KEEP, ActionSize.PHRASE, ActionAmount.NEUTRAL),
        ActionTypeV2.CUT_PHRASE: (ActionType.CUT, ActionSize.PHRASE, ActionAmount.NEUTRAL),
        ActionTypeV2.KEEP_2_BARS: (ActionType.KEEP, ActionSize.TWO_BARS, ActionAmount.NEUTRAL),
        ActionTypeV2.CUT_2_BARS: (ActionType.CUT, ActionSize.TWO_BARS, ActionAmount.NEUTRAL),
        ActionTypeV2.KEEP_2_PHRASES: (ActionType.KEEP, ActionSize.TWO_PHRASES, ActionAmount.NEUTRAL),
        ActionTypeV2.CUT_2_PHRASES: (ActionType.CUT, ActionSize.TWO_PHRASES, ActionAmount.NEUTRAL),
        ActionTypeV2.LOOP_BEAT: (ActionType.LOOP, ActionSize.BEAT, ActionAmount.NEUTRAL),
        ActionTypeV2.LOOP_BAR: (ActionType.LOOP, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.LOOP_PHRASE: (ActionType.LOOP, ActionSize.PHRASE, ActionAmount.NEUTRAL),
        ActionTypeV2.JUMP_BACK_4: (ActionType.JUMP_BACK, ActionSize.BEAT, ActionAmount.NEG_SMALL),
        ActionTypeV2.JUMP_BACK_8: (ActionType.JUMP_BACK, ActionSize.BEAT, ActionAmount.NEG_LARGE),
        ActionTypeV2.SKIP_TO_NEXT_PHRASE: (ActionType.SKIP, ActionSize.PHRASE, ActionAmount.NEUTRAL),
        ActionTypeV2.REORDER_BEAT: (ActionType.REORDER, ActionSize.BEAT, ActionAmount.NEUTRAL),
        ActionTypeV2.REORDER_BAR: (ActionType.REORDER, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.REORDER_PHRASE: (ActionType.REORDER, ActionSize.PHRASE, ActionAmount.NEUTRAL),
        ActionTypeV2.FADE_IN: (ActionType.FADE_IN, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.FADE_OUT: (ActionType.FADE_OUT, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.DOUBLE_TIME: (ActionType.DOUBLE_TIME, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.HALF_TIME: (ActionType.HALF_TIME, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.REVERSE_BAR: (ActionType.REVERSE, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.REVERSE_PHRASE: (ActionType.REVERSE, ActionSize.PHRASE, ActionAmount.NEUTRAL),
        ActionTypeV2.REPEAT_PREV_BAR: (ActionType.REPEAT_PREV, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.REPEAT_PREV_PHRASE: (ActionType.REPEAT_PREV, ActionSize.PHRASE, ActionAmount.NEUTRAL),
        ActionTypeV2.SWAP_WITH_NEXT_BAR: (ActionType.SWAP_NEXT, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.SWAP_WITH_NEXT_PHRASE: (ActionType.SWAP_NEXT, ActionSize.PHRASE, ActionAmount.NEUTRAL),
        ActionTypeV2.GAIN_UP_1: (ActionType.GAIN, ActionSize.BAR, ActionAmount.POS_SMALL),
        ActionTypeV2.GAIN_DOWN_1: (ActionType.GAIN, ActionSize.BAR, ActionAmount.NEG_SMALL),
        ActionTypeV2.GAIN_UP_3: (ActionType.GAIN, ActionSize.BAR, ActionAmount.POS_LARGE),
        ActionTypeV2.GAIN_DOWN_3: (ActionType.GAIN, ActionSize.BAR, ActionAmount.NEG_LARGE),
        ActionTypeV2.BOOST_LOW: (ActionType.EQ_LOW, ActionSize.BAR, ActionAmount.POS_LARGE),
        ActionTypeV2.CUT_LOW: (ActionType.EQ_LOW, ActionSize.BAR, ActionAmount.NEG_LARGE),
        ActionTypeV2.BOOST_HIGH: (ActionType.EQ_HIGH, ActionSize.BAR, ActionAmount.POS_LARGE),
        ActionTypeV2.CUT_HIGH: (ActionType.EQ_HIGH, ActionSize.BAR, ActionAmount.NEG_LARGE),
        ActionTypeV2.ADD_DISTORTION: (ActionType.DISTORTION, ActionSize.BAR, ActionAmount.NEUTRAL),
        ActionTypeV2.ADD_REVERB: (ActionType.REVERB, ActionSize.BAR, ActionAmount.NEUTRAL),
    }
    
    atype, asize, aamount = mapping.get(
        old_action, 
        (ActionType.KEEP, ActionSize.BEAT, ActionAmount.NEUTRAL)
    )
    
    return FactoredAction(
        action_type=atype,
        action_size=asize,
        action_amount=aamount,
